...
<%
 ...
 try {
  sql = "select * from qfreeboard where id="+id ;
  ...
  %>
  <FORM name='msgrewrite'  method=POST action="Qfreeboard_rsave.jsp?id=<%=id%>&page=<%=request.getParameter("page")%>">
     ...
     <td colspan="2" align="right"> 
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
       <tr> 
        ...
        <td width="12%"><A href="Qfreeboard_list.jsp?go=<%=request.getParameter("page") %>"> <img src="image/list.jpg" border=0></a></td>
       </tr>
      </table>
     </td>
    </tr>
